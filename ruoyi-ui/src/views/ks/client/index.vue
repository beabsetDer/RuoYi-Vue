...
<script>
import { listClient, getClient, delClient, addClient, updateClient } from "@/api/ks/client";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除客戶公司表單编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ks/client/export', {
        ...this.queryParams
