<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="expenseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="日常開支日期" align="center" prop="expenseDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.expenseDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="機司名稱" align="center" prop="expenseDriver" />
      <el-table-column label="車牌" align="center" prop="expenseLicensePlateNumber" />
      ...
      <el-table-column label="日常開支總額" align="center" prop="expenseTotal" />
